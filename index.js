...
+ 'TEL;type=CELL;type=VOICE;waid=558298409509:+55 82 9840-9509\n' // Nomor bot
...
Modelo ${prefix}verify untuk para começar a usar bot.`
				...
				teks = `Estamos Perdendo Cornos @${num.split('@')[0]} Adeus👋`
